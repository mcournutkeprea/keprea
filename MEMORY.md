...
| 03 juil. 2026 (2-4) | Vague 2 pré-publication : badge ravageur bioprotection, listes Maraîchage/Viticulture complétées, Biofertilisant timing détaillé, Boosters fréquence clarifiée. Stats "Agriculture en transition" (84%/100%/5500) confirmées fiables par l'utilisateur → restaurées (commit `0b97b76`). Décisions NPK 15-15-15 vs Fertea432 et claim "azote rapide" tranchées (conservé/écarté). |
