...
- ~~3 pages orphelines absentes du sitemap (`/ressources`, `/ressources/fiches-techniques`, 5 fiches produit)~~ — **Corrigé (24/07/2026)** : les 7 URLs ajoutées à `public/sitemap.xml` (20 URLs au total désormais, XML validé). Confirmé par croisement avec `src/routes.tsx`.
