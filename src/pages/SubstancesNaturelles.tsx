  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-green-50">
        <div className="container mx-auto max-w-2xl text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">Rejoignez la révolution de l'agriculture performante et écologique avec nos substances naturelles innovantes.</p>
