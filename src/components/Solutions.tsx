        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/5 to-primary/10 p-12 min-h-[400px]">
            <div className="relative z-10">
              <h3 className="text-2xl font-extrabold mb-2 text-white">{t('solutions.booster.title')}</h3>
              <p className="text-lg font-semibold text-white/90 mb-6">{t('solutions.booster.subtitle')}</p>
              
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 rounded-full bg-white"></div>
                  <span className="text-sm font-semibold text-white">Boostea13 - riche en acides aminés libres</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 rounded-full bg-white"></div>
                  <span className="text-sm font-semibold text-white">Fertilea432 - riche en matière organique</span>
                </div>
              </div>
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-secondary/5 to-secondary/10 p-12 min-h-[400px]">
            <div className="relative z-10">
              <h3 className="text-2xl font-extrabold mb-2 text-white">{t('solutions.biocontrol.title')}</h3>
              <p className="text-lg font-semibold text-white/90 mb-6">{t('solutions.biocontrol.subtitle')}</p>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-semibold text-white">{t('solutions.biocontrol.nematicide')}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-semibold text-white">{t('solutions.biocontrol.pest')}</span>
                  </div>
                </div>
              </div>
            </div>
