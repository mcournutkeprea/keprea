      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-background rounded-2xl p-8 shadow-lg border border-border">
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              Implantée à proximité de <strong className="text-primary font-semibold">Dole dans le Jura</strong>, notre site de production de <strong className="text-primary font-semibold">3 000 m²</strong> nous permet de développer une gamme complète de solutions pour les agriculteurs : solutions de <strong className="text-primary font-semibold">bioprotection</strong> performantes et abordables, <strong className="text-primary font-semibold">boosters</strong> et activateurs de sols pour la résistance des cultures contre les stress abiotiques. Toutes ces solutions étant utilisables en <strong className="text-primary font-semibold">agriculture biologique</strong>.
            </p>
